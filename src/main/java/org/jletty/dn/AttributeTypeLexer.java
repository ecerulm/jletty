// $ANTLR 2.7.6 (2005-12-22): "attributetypelexer.g" -> "AttributeTypeLexer.java"$
...
public class AttributeTypeLexer extends antlr.CharScanner implements AttributeTypeLexerTokenTypes, TokenStream
 {

  	Logger logger = Logger.getLogger("org.jletty.DnParsing");	 
public AttributeTypeLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public AttributeTypeLexer(Reader in) {
	this(new CharBuffer(in));
}
public AttributeTypeLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public AttributeTypeLexer(LexerSharedInputState state) {
	super(state);
...
tryAgain:
	...
	protected final void mKEYCHAR(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = KEYCHAR;
		int _saveIndex;
