// $ANTLR 2.7.6 (2005-12-22): "namelexer.g" -> "NameLexer.java"$
...
public class NameLexer extends antlr.CharScanner implements NameLexerTokenTypes, TokenStream
 {

  	Logger logger = Logger.getLogger("org.jletty.DnParsing");	 
public NameLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public NameLexer(Reader in) {
	this(new CharBuffer(in));
}
public NameLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public NameLexer(LexerSharedInputState state) {
	super(state);
