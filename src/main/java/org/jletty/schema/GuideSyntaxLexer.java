// $ANTLR 2.7.6 (2005-12-22): "guidesyntaxparser.g" -> "GuideSyntaxLexer.java"$
...
public class GuideSyntaxLexer extends antlr.CharScanner implements GuideSyntaxParserTokenTypes, TokenStream
 {
public GuideSyntaxLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public GuideSyntaxLexer(Reader in) {
	this(new CharBuffer(in));
}
public GuideSyntaxLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public GuideSyntaxLexer(LexerSharedInputState state) {
	super(state);
...
tryAgain:
	...
	public final void mOID(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = OID;
		int _saveIndex;
	...
	public final void mDESCSTRING(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = DESCSTRING;
		int _saveIndex;
